...
{
    /// <summary>
    ///     Отправляет заявку от пользователя с Guid <paramref name="userGuid" /> пользователю с Guid
    ///     <paramref name="friendUserGuid" />
    /// </summary>
    ...
    /// <summary>
    ///     Принимает заявку от пользователя с Guid <paramref name="senderUserGuid" /> пользователю
    ///     <paramref name="accepterUserGuid" />
    /// </summary>
    ...
    /// <summary>
    ///     Отменяет или отклоняет заявку между пользователями <paramref name="firstUserGuid" /> и
    ///     <paramref name="secondUserGuid" />
    ...
    /// <summary>
    ///     Удаляет из списка друзей пользователя с Guid <paramref name="userGuid" /> пользователя с Guid
    ///     <paramref name="deletedFriendUserGuid" />
    /// </summary>
