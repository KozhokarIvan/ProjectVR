...
namespace ProjectVR.Domain.Interfaces.Repositories
{
    ...
    {
        /// <summary>
        /// Возвращает массив пользователей, у которых игры или вр гарнитуры совпадают со строкой поиска <paramref name="query"/>
        /// </summary>
        ...
        /// <summary>
        /// Возвращает массив пользователей, у которых есть хотя бы одна игра совпадающая по названию с <paramref name="gameName"/>
