...
namespace ProjectVR.DataAccess.Repositories
{
    public class UsersRepository : IUsersRepository
    {
        ...
        public async Task<UserSummary[]> FindUsersByGameAndVrset(string? game, string? vrset, int offset, int limit, Guid? ignoredUserGuid = null)
        {
            ...
            .Where(u =>
                ...
                && (!ignoredUserGuid.HasValue || u.Friends.Any(f => f.ToUserGuid != ignoredUserGuid && f.FromUserGuid != ignoredUserGuid)))
        ...
        public async Task<UserSummary[]> FindUsersByGameOrVrSet(string query, int offset, int limit, Guid? ignoredUserGuid = null)
        {
