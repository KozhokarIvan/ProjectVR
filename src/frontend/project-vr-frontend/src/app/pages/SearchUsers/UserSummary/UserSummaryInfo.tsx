  ...
  return (
    <Grid>
      <Text>
        ...
        dicta quaerat dolores nam incidunt esse aut minus beatae aliquam
        obcaecati. Optio distinctio ab saepe laborum, rerum sapiente voluptatum
        consequatur iusto nulla libero qui fugit obcaecati quaerat aliquam nisi
        nihil explicabo quisquam. Tempore omnis corrupti officia id similique
        cupiditate, voluptate nihil odit consequuntur explicabo vitae debitis
